...
class _BegetClient(object):
    ...
    def add_txt_record(self, domain_name, record_name, record_content, record_priority = 10):
        ...
        records = self._find_records(domain_name)
    ...
    def del_txt_record(self, domain_name, record_name, record_content):
        ...
        for recordTxt in records['TXT']:
            if recordTxt['txtdata'] != record_content:
                recordsTxt.append(recordTxt)

        records['TXT'] = recordsTxt
